"""
This Code I used it to enerate separate jsonl files with test, train and dev respectively. 
"""
import os
import pandas as pd
import json

# Directory where all the JSON Lines files are located
jsonl_files_dir = "D:/CodingProjects/PythonProjects/1.1/data"

# Directory where you want the Excel files for the languages to be stored
